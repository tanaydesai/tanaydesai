...
export default function Home() {
  return (
   <div className='mx-auto mb-100'>
      <Intro />
      <h1 className='[font-family:"Maglite"] mt-[200px] mb-[150px] px-10 md:px-20 text-left text-[30px] lg:text-[45px] w-full'><TbTopologyStarRing3 className='inline'/> Projects</h1>
      <CardExploreAI />
      <CardUiaftersex />
