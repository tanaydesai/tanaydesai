      ...
      <Tabs defaultValue="about">
        ...
        <TabsContent value="work">
            ...
            <Fade sentence={`Some of my major projects, always a work in progress:)`} />
              ...
              <div className="text-gray-500 ml-2 text-[17px] mt-2 cursor-default font-LufgaLight hover:underline hover:decoration-slate-400"><DecryptText text="pluto - build small language models with synthetic data from scratch ↗"/></div>
              <div className="text-gray-500 ml-2 text-[17px] mt-2 cursor-default font-LufgaLight hover:underline hover:decoration-slate-400"><DecryptText text="atomgrad - simple autograd engine between micrograd and tinygrad ↗"/></div>
        </TabsContent>
