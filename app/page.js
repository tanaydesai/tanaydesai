...
const Home = () => {
  ...
  return (
    <Tabs defaultValue="about" className="w-full h-fit">
        ...
        <TabsContent value="about" className="w-full bg-[#191919] h-fit pb-10">
        ...
        <TabsContent value="work" className="w-full bg-[#ebeaea] h-fit pb-10">
        ...
        <TabsContent value="thoughts" className="w-full bg-[#191919] h-fit pb-10">
        <div className="body bg-[#191919]">
          <div className="main">
