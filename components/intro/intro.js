            ...
            <AttentionSeeker effect='headShake'>
                ...
                <div className="[font-family:'Maglite'] max-w-[1000px] leading-loose">a <span className='[font-family:"LufgaLight"] inline-flex text-[25px] rounded-[25px] h-[55px] lg:min-h-[40px] bg-pink-400 p-2 -rotate-6 justify-items-center items-center'>Mumbai <SlLocationPin className='inline'/></span> based  
                    <motion.span style={hover2 && {color:"white",backgroundColor:"black"}} onHoverStart={()=>setHover2(true)} onHoverEnd={()=>setHover2(false)} className='[&::-webkit-scrollbar]:hidden inline-flex h-[50px] lg:h-[70px] mx-3 p-2 items-center overflow-hidden border-solid whitespace-nowrap border-2 w-fit border-black rounded-[17px]  hover:bg-black  hover:text-white'>
                        {!hover2 ? "software" : <Marquee className='[&::-webkit-scrollbar]:hidden max-w-[118px] lg:max-w-[177px]' direction="left" loop={0} speed={150}>software-web-app-</Marquee>}
                    </motion.span>
                    ...
                    <motion.span style={hover && {color:"white",backgroundColor:"black"}} onHoverStart={()=>setHover(true)} onHoverEnd={()=>setHover(false)} className='[&::-webkit-scrollbar]:hidden inline-flex h-[50px] lg:h-[70px] mx-3 p-2 items-center overflow-hidden border-solid whitespace-nowrap border-2 w-fit border-black rounded-[17px]  hover:bg-black  hover:text-white'>
                        {!hover ? "craftsman" : <Marquee className='[&::-webkit-scrollbar]:hidden max-w-[138.5px] lg:max-w-[208px]' direction="left" loop={0} speed={150}>craftsman-designer-developer-</Marquee>}
                    </motion.span>
